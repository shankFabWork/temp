                    ...
                    <div id='hero' className="flex flex-col lg:flex-row py-8 justify-between text-center lg:text-left">
                        <div className="lg:w-1/2 flex flex-col justify-center" data-aos="zoom-in" data-aos-delay="200">
                            ...
                            {/* We build digital solutions to help businesses scale */}
                                From raw data to actionable insights — we engineer data that drives decisions.
                            </h1>
                            <div className="text-xl font-semibold tracking-tight mb-5 text-gray-500">Our team is well vast in Data Engineer and is ready to help develop the applications of your choice.</div>
